...
Après le chapitre 2 qui a posé la vision d'ensemble de Symfony UX, ce chapitre descend au niveau du code. On va répondre à cinq questions :
...
> ⚠️ **À retenir** : un Twig Component est **statique**. Il rend une fois, côté serveur, et c'est terminé. C'est son rôle — et c'est déjà énorme. La réactivité (état, interactions) arrive au chapitre 4 avec Live Components.

---

## Slide 3.1 — Qu'est-ce qu'un Twig Component ?

### Définition

> **Une classe PHP + un template Twig = un composant réutilisable.**

C'est la réponse directe aux **deux premières douleurs** identifiées au chapitre 1 :
...
## Slide 3.4 — Slots : passer du contenu dans un composant
...
## Slide 3.5 — Services, méthodes calculées et `mount()`
...
Chaque `<twig:MonComposant />` est une **instance fraîche** à chaque rendu de la page. Aucune donnée ne persiste entre deux affichages. Si tu as besoin de persistance ou de réactivité → Live Components (chapitre 4).
...
## Slide 3.9 — Récap : les douleurs du chapitre 1 répondues

Reprenons la grille des cinq critères du chapitre 1 :
...
Deux cases restent vides — c'est **volontaire**. Twig Components résout les douleurs 1 et 2 du chapitre 1 (typage, organisation). Il ne prétend pas résoudre la troisième (réactivité) : c'est l'objet de Live Components.
