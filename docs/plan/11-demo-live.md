...
Deux démos **courtes et percutantes** pour rendre le concept tangible.

---

## Slide 11.1 — Le plan de démo
...
## Slide 11.3 — Ce qu'on veut que le public retienne
...
Maintenant qu'on a vu la solution en action, parlons **stratégie d'adoption**.
